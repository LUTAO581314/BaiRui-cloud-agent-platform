...
- The `skills` view is the second migrated module: it consumes only
  Agent-scoped discovery, authorization and skill-preference commands; a
  missing Runtime capability remains visibly unavailable.
