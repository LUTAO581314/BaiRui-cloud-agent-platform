...
test("Platform consumes the published Contracts release without claiming Gate C00", () => {
  ...
  const dependency = "https://codeload.github.com/LUTAO581314/BaiRui-contracts/tar.gz/refs/tags/v2.3.0-rc.1";
  ...
  assert.equal(lock.packages["node_modules/@bairui/contracts"].version, "2.3.0-rc.1");
  assert.match(lock.packages["node_modules/@bairui/contracts"].integrity, /^sha512-/);
  assert.equal(CONTRACTS_VERSION, "2.3.0-rc.1");
  ...
  assert.match(status, /52b4e19043c5e5a8ce45ddefcde6768c06df9151/);
